# -*- coding: utf-8 -*-
"""
Created on Sun Nov 18 15:24:46 2018
...
def best_words_selection(word_scores, number):
    scores = sorted(word_scores.items(), key= lambda x: x[1], reverse=True)[:number]
    best_words = set([w for w, s in scores])
    return best_words
